        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.partTop}>
                ...
                <View style={styles.image}>
                    <Image source={require('../../../assets/like.png')} style={styles.imageImage} />
                </View>
                <View style={styles.partTopText}>
                    <Text style={{ fontSize: 24, justifyContent: 'center', textAlign: 'center', color: 'black', paddingBottom: 10, fontWeight: 'bold' }}>Xin cảm ơn</Text>
                    <Text style={{ fontSize: 18, justifyContent: 'center', textAlign: 'center', color: 'black' }}>Bạn đã đặt hàng thành công!</Text>
                </View>
            </View>
